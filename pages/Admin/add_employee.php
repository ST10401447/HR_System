...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $company_id = $_POST['company_id']; // Added to get company_id from form
    ...
    if ($stmt->rowCount() > 0) {
        ...
        $sql = "INSERT INTO users (name, email, employee_id, password, department, role, company_id, profile_picture) 
                VALUES (:name, :email, :employee_id, :password, :department, :role, :company_id, :profile_picture)";
...
<head>
    ...
    .login-container {
        ...
        animation: slideIn 0.8s ease-out, scaleUp 0.6s ease-out 0.2s;
